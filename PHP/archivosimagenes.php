...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET['nombre_carrera'])) {
        ...
        $sql = "SELECT imageFileName FROM imagen_archivos WHERE nombre_carrera = '$nombreCarrera'"; 
        ...
        try {
            ...
            echo json_encode(['success' => false, 'error' => 'Error al obtener las imagenes: ' . $e->getMessage()]);
            exit;
        }
    } else {
